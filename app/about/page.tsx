  ...
  return (
    <main className="relative z-10 mx-auto w-full max-w-[760px] px-4 pb-24 pt-10">
      ...
      <FadeIn>
        <div className="grid gap-8 sm:grid-cols-[1fr_180px] sm:items-start">
          ...
          <img
            ...
            style={{ aspectRatio: "4 / 5", objectFit: "cover", borderColor: "var(--line)", filter: "saturate(0.9)" }}
          />
        </div>
      </FadeIn>
        ...
        <dl className="mt-12 grid gap-0">
          {beyond.facts.map((f, i) => (
            <div
              ...
              style={{ borderTop: i === 0 ? "1px solid var(--line)" : "1px solid var(--line-soft)" }}
            >
      ...
      <section id="playbook" className="mt-20 scroll-mt-20">
        ...
        <div className="mt-8 grid gap-px sm:grid-cols-2" style={{ background: "var(--line-soft)" }}>
          {principles.map((p, i) => (
            <FadeIn key={p.n} delay={i * 0.05}>
              <div className="h-full p-6" style={{ background: "var(--bg)" }}>
      ...
      <section id="contact" className="mt-20 scroll-mt-20">
        ...
        <FadeIn>
          <ul className="mt-8 grid gap-px sm:grid-cols-2" style={{ background: "var(--line-soft)" }}>
            {contact.links.map((l) => {
